...
3. **Configure the Application Folder**  
   - In the newly added **Setup Project**, open the **File System** editor from the **View** > **Editor** > **File System**.
   - In the **File System** editor, expand the **Application Folder**.

4. **Add Project Output**  
